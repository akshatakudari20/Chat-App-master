    ...
    return (
      <Grid container component="main" className="root">
        ...
        >
          ...
          >
            <button class="btnhome">Profile</button>
          </Card>
          <div style={paper}>
            <img
              className="avatar"
            ...
            <div className="viewWrapInputFile">
              <img
                ...
                alt="icon gallery"
                src="https://firebasestorage.googleapis.com/v0/b/chat-application-21b00.appspot.com/o/ic_input_file.png?alt=media&token=5b225a03-32fe-410a-bc7d-7767897c07db"
                onClick={() => {
                  this.refInput.click();
                }}
              />
