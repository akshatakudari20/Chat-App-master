        ...
        return(
            <div id="frame">
                <div id="sidepanel">
                    <div id="profile">
                        <div class="wrap">
                            <img id="profile-img" src={this.currentUserPhoto ? this.currentUserPhoto : "https://firebasestorage.googleapis.com/v0/b/chat-application-21b00.appspot.com/o/nopic.jpg?alt=media&token=7f99a2d8-9304-4a01-be6a-076abbbcb8ff"} class="online" alt=""/>
                                    ...
                                    >
                                        <div class='wrap'>
                                            <span class="contact-status"></span>
                                             {/* put here {user.isOnline? 'Online': 'Offline'} */}
                                            <img src={item.URL ? item.URL : "https://firebasestorage.googleapis.com/v0/b/chat-application-21b00.appspot.com/o/nopic.jpg?alt=media&token=7f99a2d8-9304-4a01-be6a-076abbbcb8ff"}></img>
                                            <div class="meta">
